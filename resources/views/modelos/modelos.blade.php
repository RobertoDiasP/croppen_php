                ...
                <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p class="text-xs text-center text-secondary mb-0">{{ $iten->nome }}</p>
                                </td>
                                <td>
                                    <p class="text-xs text-secondary mb-0">{{ $iten->created_at->format('d/m/Y') }}</p>
                                </td>
                                <td>
                                    <p class="text-xs text-secondary mb-0">{{ $iten->servico->nome }}</p>
                                </td>
                                <td>
                                    <p class=" status-{{ $iten->status }}">
                                        {{ $iten->status }}
                                    </p>
                                </td>    
                            </tr>
