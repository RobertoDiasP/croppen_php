            ...
            <div class="mt-3">
                <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            @foreach ($dadosR as $iten)
                            <tr>
                                <td>
                                    <p class="text-xs text-center text-secondary mb-0">{{ $iten->descricao }}</p>
                                </td>
                                <td>
                                    <p class="text-xs text-secondary mb-0">{{ $iten->dataInicio }}</p>
                                </td>
                                <td>
                                    <p class="text-xs text-secondary mb-0">{{ $iten->dataFim }}</p>
                                </td> 
                                <td>
                                ...
                                <td>
                                    <p class="text-xs text-secondary mb-0">Botão</p>
                                </td> 
                            </tr>
                        </tbody>
                        @endforeach
