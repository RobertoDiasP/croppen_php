...
function carregarDadosDoServico() {
    ...
    $.ajax({
        ...
        error: function(error) {
            console.log('Erro Pesquisar.');
            exibirToast('Informe algum parametro para a pesquisa', '1')
        }
    });
}

function verificarCampoId() {
    var idCampo = $('#id').val();
    var resultado = idCampo ? 1 : 0;
...
function atualizarRegistro() {
    ...
    $.ajax({
        url: '/servicoUpdate', // Substitua com sua rota de atualização
        type: 'PUT',
        data: formData,
        headers: {
        ...
        success: function(response) {
            ...
            exibirToast('Operação concluída com sucesso!', 'success')
        },
        error: function(error) {
            console.log('Erro ao atualizar o registro.');
            exibirToast('Ocorreu algum problema porfavor entre em contado com o suporte!', '1')
        }
    });
}
